...
class DOMNode implements AsDOMNode {
  ...
  EventStream<Object> get onGenerate => _onGenerate ??= EventStream();
...
class DOMElement extends DOMNode with WithValue implements AsDOMElement {
  ...
  EventStream<DOMMouseEvent> get onClick => _onClick ??= EventStream();
  ...
  EventStream<DOMEvent> get onChange => _onChange ??= EventStream();
  ...
  /// Event handler for `change` events.
  EventStream<DOMEvent> get onKeyPress => _onKeyPress ??= EventStream();
  ...
  /// Event handler for `change` events.
  EventStream<DOMEvent> get onKeyUp => _onKeyUp ??= EventStream();
  ...
  /// Event handler for `change` events.
  EventStream<DOMEvent> get onKeyDown => _onKeyDown ??= EventStream();
  ...
  EventStream<DOMMouseEvent> get onMouseOver => _onMouseOver ??= EventStream();
  ...
  EventStream<DOMMouseEvent> get onMouseOut => _onMouseOut ??= EventStream();
  ...
  EventStream<DOMEvent> get onLoad => _onLoad ??= EventStream();
